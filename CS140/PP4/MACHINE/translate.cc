...
// from the virtual address
	...
	if (vpn >= pageTableSize) {
	    DEBUG(dbgAddr,("Illegal virtual page # 0x%x\n", virtAddr));
	    return AddressErrorException;
	} else if (!pageTable[vpn].valid) {
	    DEBUG(dbgAddr,("Invalid virtual page # 0x%x\n", virtAddr));
	...
	DEBUG(dbgAddr,("Write to read-only page at 0x%x\n", virtAddr));
	...
	DEBUG(dbgAddr,("Illegal pageframe 0x%x\n", pageFrame));
